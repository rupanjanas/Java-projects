...
public class LRUCacheTest extends CacheTest {
    ...
    public void get_shouldModifyLastRecentUsageToBecomeThatKey() {
        ...
        cache.put(1, "one");
        cache.put(6, "six");
        assertThat("Initially last used is 6", ((LRUCache<Integer, String>) cache).getLastRecentKey().get(), is(6));
        cache.get(1);
        assertThat("After get(1) last used is 1", ((LRUCache<Integer, String>) cache).getLastRecentKey().get(), is(1));
    }

    @Test
    public void getLastRecentKey_shouldReturnAnEmptyOptionalIfNoCachedElements() {
        assertThat(((LRUCache<Integer, String>) cache).getLastRecentKey().isPresent(), is(false));
    }
    ...
    public void put_shouldUpdateLastUsedElementIfKeyAlreadyExists() {
        ...
        cache.put(3, "three");
        assertThat("3 is the last used key", ((LRUCache<Integer, String>) cache).getLastRecentKey().get(), is(3));
    }
}
